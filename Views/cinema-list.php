...
<div class="center card shadow-sm " >   
    <div class="form-group nospace inline  ">
      ...
      <form action="<?php echo FRONT_ROOT ?>Cinema/Get" method="get">
        <input type="radio" name="orderedBy" value="name" onclick="this.form.submit()" checked><h6 class= "mb-1 text-muted small">Nombre</h6>
        <input type="radio" name="orderedBy" value="capacity" onclick="this.form.submit()"><h6 class= "mb-1 text-muted small">Capacidad</h6>
        <input type="radio" name="orderedBy" value="price" onclick="this.form.submit()"><h6 class= "mb-1 text-muted small">Precio</h6>
      </form>
    </div>
  </div>
</div>
