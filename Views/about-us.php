...
?>
    ...
    <div class="row">
        <div class="card flex-md-row mb-4 shadow-sm h-md-250" style="align-items:center;margin-left:100px;width:700px;">
                <img class="card-img-left flex-auto d-none d-lg-block" alt="Movie_Poster_[180x250]" src="<?php echo FRONT_ROOT . IMG_PATH?>Logo.jpg" style="width: 180px; height: 250px;">
        ...
        <div class="card flex-md-row mb-4 shadow-sm h-md-250" style="align-items:center;margin-left:auto;margin-right:100px;width:700px;">
                ...
                <img class="card-img-right flex-auto d-none d-lg-block" alt="Movie_Poster_[180x250]" src="<?php echo FRONT_ROOT . IMG_PATH?>Logo.jpg" style="width: 180px; height: 250px;">    
        </div>
